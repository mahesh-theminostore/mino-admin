...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  useOutsideClickHandler<HTMLDivElement>(ref, onOutsideClick);
      ...
      <div className='relative z-20 inline-block w-full' ref={ref}>
        <div className='relative flex flex-col items-center'>
          <div onClick={toggleDropdown} className='w-full'>
            <div className='mb-2 flex min-h-11 rounded-lg border border-gray-300 py-1.5 pr-3 pl-3 shadow-theme-xs outline-hidden transition focus:border-brand-300 focus:shadow-focus-ring dark:border-gray-700 dark:bg-gray-900 dark:focus:border-brand-300'>
          ...
          {isOpen && (
            <div
              className='absolute top-full left-0 z-40 max-h-70 w-full overflow-y-auto rounded-lg bg-white shadow-sm dark:bg-gray-900'
